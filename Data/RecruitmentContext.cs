...
namespace Recruiter.Data
{
    ...
    {
        public RecruitmentContext(string dbConnectionString)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=9MMBQG3\\TRIAL;Database=Recruitment;User Id=sa;Password=P@ssw0rd");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>(entity =>
            {
                ...
                entity.HasIndex(e => e.CSocialSecurityNo, "UQ__Employee__6AB6057F589384FB")
                    .IsUnique();
